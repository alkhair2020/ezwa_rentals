    ...
    height: 71PX;" />
            ...
            <div id="invoice-customer-details" class="row mt-1  border border-1 border-dark p-1"
              ...
              <div class="col-md-3 col-sm-12 ">
                <p>
                  {{$receipts->created_at->format('Y-m-d') }} م
                </p>
                <p>
                  <span class="text-muted"></span> {{$receipts->create_hijriDate}} هـ
                </p>
              </div>
            ...
            <div id="invoice-customer-details" class="row   border border-1 border-dark "
              ...
              <div class="col-md-3 col-sm-12 mt-2">
                <p>
                    <span class="text-muted">استلمت من السيد :</span>
                </p>
                <p>
