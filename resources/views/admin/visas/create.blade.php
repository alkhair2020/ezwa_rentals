                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form">بيانات الزيارة</h4>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="typeId" name="type" class="form-control">
                                                    ...
                                                    <option value="room">زيارة عمل</option>
                                                    <option value="room">تأشيرة العمرة</option>
                                                    <option value="" selected="" disabled=""> تأشيرة العمل</option>
                                                    <option value="apartment"> تأشيرة الإقامة</option>
                                                    <option value="room">تأشيرة الحج</option>
                                                    <option value="room">تأشيرة الدراسة</option>
                                                    <option value="room">تأشيرة العلاج</option>
                                                    <option value="room">تأشيرة الفعاليات</option>
                                                </select>
