                    ...
                    <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered multi-ordering">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$maintenance->properties->number}}</td>
                                    <td>{{$maintenance->clients->id}}</td>
                                    <td> 
                                        @if($maintenance->bathroom==1)
                                            ✓
                                        @endif
                                    </td>
                                    <td> 
                                        @if($maintenance->conditioning==1)
                                            ✓
                                        @endif
                                    </td>
                                    <td> 
                                        @if($maintenance->door==1)
                                            ✓
                                        @endif
                                    </td>
                                    <td> 
                                        @if($maintenance->room==1)
                                            ✓
                                        @else
                                    ...
                                    <td> 
                                        @if($maintenance->kitchen==1)
                                            ✓
                                        @endif
                                    </td>
                                    <td> 
                                        @if($maintenance->other==1)
                                            ✓
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm bg-success-light"
                                            href="{{ url('admin/maintenances/print', $maintenance->id) }}">
                                            <button type="button" class="btn btn-icon btn-info mr-1"><i
                                                    class="la la-print"></i></button>
                                        </a>
                                        <a class="btn btn-sm bg-success-light"  href="{{ url('admin/maintenances/'.$maintenance->id).'/edit' }}"">
                                            <i class="la la-edit"></i>
                                        </a>
                                        <a data-toggle="modal" data-catid="{{ $maintenance->id }}" data-target="#delete"
