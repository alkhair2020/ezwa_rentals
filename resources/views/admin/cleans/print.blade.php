          ...
          <div id="invoice-template" class="card-body">
            ...
            <div id="" class="row ">
              <div class="col-md-12 col-sm-12 pt-2">
                <p> التاريـــــــــخ : {{$cleans->created_at->format('Y-m-d') }} م</p>
                <p > الموافــــــق : {{$cleans->create_hijriDate }} هـ</p>
                <p > رقم الشقة : {{$cleans->properties->number }} </p>
              </div>
            </div>
            <br>
            <div id="" class="row text-center">
              <div class="col-md-12 col-sm-12 pt-2">
              <u><h2> معلومات النظافة</h2></u>
              </div>
            </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                            <input type="checkbox" value="1" {{ $cleans->bathroom == '1' ? 'checked' : '' }}>
                            </td>
                            <td class="text-center"> {{ $cleans->bathroom_desc}}</td>
                        </tr>
                        <tr>
                            <td class="text-center">
                                 المكيفات
                            ...
                            <td class="text-center">
                            <input type="checkbox" value="1" {{ $cleans->conditioning == '1' ? 'checked' : '' }}>
                            </td>
                            <td class="text-center"> {{ $cleans->conditioning_desc}} </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                                 الابواب
                            ...
                            <td class="text-center">
                            <input type="checkbox" value="1"  {{ $cleans->door == '1' ? 'checked' : '' }}>
                            </td>
                            <td class="text-center"> {{ $cleans->door_desc}}</td>
                        </tr>
                        <tr>
                            <td class="text-center">
                                الغرف
                            ...
                            <td class="text-center">
                            <input type="checkbox" value="1"   {{ $cleans->room == '1' ? 'checked' : '' }}>
                            </td>
                            <td class="text-center"> {{ $cleans->room_desc}}</td>
                        </tr>
                        <tr>
                            <td class="text-center">
                                المطبخ
                            ...
                            <td class="text-center">
                            <input type="checkbox" value="1"   {{ $cleans->kitchen == '1' ? 'checked' : '' }}>
                            </td>
                            <td class="text-center"> {{ $cleans->kitchen_desc}} </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                                ملحقات أخر
                            ...
                            <td class="text-center">
                            <input type="checkbox" value="1"  {{ $cleans->other == '1' ? 'checked' : '' }}>
                            </td>
                            <td class="text-center">{{ $cleans->other_desc}} </td>
                        </tr>
            ...
            <div id="invoice-customer-details" class="row " style="">
                <div class="col-md-6 col-sm-12 " style="">
                    ...
                    <p class="ml-2">توقيع عامل النظافة :</p>
                    <p class="ml-2">
                    تاريخ الإنجاز : 
                    </p>
                </div>
